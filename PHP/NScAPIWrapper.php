...
class NScAPIWrapper {
 ...
 public function getCustomerDetails($email) {
   $requestUrl = "http://api.internal.nitrosell.com/".$this->webstoreUrl."/v1/customer.json";
 ...
 public function getShippingOptions($postargs) {
   $requestUrl = "http://api.internal.nitrosell.com/".$this->webstoreUrl."/v1/shipping.json";
 ...
 public function getTaxForAnOrder($postargs) {
   $requestUrl = "http://api.internal.nitrosell.com/".$this->webstoreUrl."/v1/tax.json";
   $arrRawPostParameters = array();
   $arrParameters = array();
   parse_str($postargs, $arrRawPostParameters);
 ...
 public function insertWebOrders($param) {
   $requestUrl = "http://api.internal.nitrosell.com/".$this->webstoreUrl."/v1/order.json";
   $arrRawPostParameters = array();
   $arrParameters = array();
 ...
 public function getShippingAndTax($postargs) {
   $requestUrl = "http://api.internal.nitrosell.com/".$this->webstoreUrl."/v1/shippingandtax.json";
   $arrRawPostParameters = array();
   $arrParameters = array();
   parse_str($postargs, $arrRawPostParameters);
